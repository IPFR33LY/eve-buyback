...
from functions.buybackContractsParser.buybackContractsParser import BuybackContractsParser
from functions.buybackContractsParser.buybackContractsParser import lambda_handler
...
class ContractsParserTest(unittest.TestCase):
    def setUp(self):
        self.sut = BuybackContractsParser()
    ...
    def test_lambda(self):
        main_method = mock.patch.object(BuybackContractsParser, 'main').start()
